...
export const MissingCRN = () => {
    ...
    const handleSectionChange = (e) => {
        ...
        const newSection = e.currentTarget.value ? e.currentTarget.value : "000"
    ...
    return (
        <div className="container bg-dark">
            ...
            <div className="row text-center mt-5">
                <div className="col">
                    <button className="btn btn-secondary" onClick={handleSubmitOrDownload}>{!sectionsSubmitted ? "Submit" : "Download"}</button>
                </div>
            </div>
        </div>
    )
